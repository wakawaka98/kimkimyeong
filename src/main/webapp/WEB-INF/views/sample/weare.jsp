			...
			<section class="weare-body float-clear">
				<ul>
					<li><a href="javascript:;">
							...
							src="/resources/sample/img/logo2.png" alt="겔러리게시물1">
							<h2>겔러리제목1</h2>
							<p>겔러리게시물 1번의 내용 입니다. 여러분 환영합...</p>
					</a></li>
					<li><a href="javascript:;"> <img
							src="/resources/sample/img/logo2.png" alt="겔러리게시물2">
							<h2>겔러리제목2</h2>
							<p>겔러리게시물 2번의 내용 입니다. 여러분 환영합...</p>
					</a></li>
					<li><a href="javascript:;"> <img
							src="/resources/sample/img/logo2.png" alt="겔러리게시물3">
							<h2>겔러리제목3</h2>
							<p>겔러리게시물 3번의 내용 입니다. 여러분 환영합...</p>
					</a></li>
					<li><a href="javascript:;"> <img
							src="/resources/sample/img/logo2.png" alt="겔러리게시물4">
							<h2>겔러리제목4</h2>
