        ...
        <div class="row"><!-- 부트스트랩의 디자인 클래스 row -->
          ...
          <div class="card card-primary">
              ...
              <div class="card-body">
                ...
                <p class="text-muted">
                ${user_id2} <c:out value="${user_id2}"></c:out></p>
                ...
                <strong><i class="fas fa-file-alt mr-1"></i>point</strong>
          ...
          <!-- 버튼영역 시작 -->
            <div class="card-body">
            	<a href="/admin/member/member_list" class="btn btn-primary float-right mr-1">LIST ALL</a>
              	<button type="button" class="btn btn-danger float-right mr-1">DELEETE</button>
